                ...
                <table class="table-auto border-collapse bgColor-trans m-0-auto">
                    <thead class="txt-h-c">
                      <tr class="bgColor-1 border-8 b-solid b-color-1">
                        <th class="px-4 py-2 color-2-700">FullName</th>
                    ...
                    <tbody>
                        <tr class="bgColor-1 border-8 b-solid b-color-1">
                            <td class="px-4 py-1 color-2-600 border-0"> Erick MuCIRA </td>
                            <td class="px-4 py-1 color-2-600 border-0"> erick@gmail.com </td>
                             <td class="px-4 py-1 color-2-600 border-0">0789344566</td>
